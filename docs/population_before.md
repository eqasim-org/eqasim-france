...
```bash
git clone https://github.com/eqasim-org/eqasim-france
```

which will create the `eqasim-france` folder containing the pipeline code. To
...
This will create a new Anaconda environment with the name `eqasim-france`.

To activate the environment, run:

```bash
conda activate eqasim-france
```
...
- [Running a MATSim simulation](https://github.com/eqasim-org/eqasim-france/blob/develop/docs/simulation.md)
