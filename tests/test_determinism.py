...
def _test_determinism(index, data_path, tmpdir):
    ...
    manager.check(
        ...
        "be7fbc96b85f4a052151a89a4b77eed4")
    ...
    manager.check(
        ...
        "5ba773b1220660c177b7cd9661124217")
    ...
    manager.check(
        ...
        "79e118f9e13e9ba267edc9f240e16418")
