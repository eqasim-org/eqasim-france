...
def _test_determinism(index, data_path, tmpdir):
    ...
    manager.check(
        ...
        "d66f56c6f07ddc91fe29fdcc18b5772b")
    ...
    manager.check(
        ...
        "bc3201143ced552e715f8a7cb1b39842")
    ...
    manager.check(
        ...
        "bda54cdbcf6ade265fceedf55590f5ae")
