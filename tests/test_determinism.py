...
def _test_determinism(index, data_path, tmpdir):
    ...
    manager.check(
        ...
        "16264a11024745afcc71dbec95a3b0d1")
...
def _test_determinism_matsim(index, data_path, tmpdir):
    ...
    manager.check(
        ...
        "54c8f1d7136beda2a00b8976aa85b13a")
