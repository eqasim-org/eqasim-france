...
def create(output_path):
    ...
    df_bpe = df.iloc[random.randint(0, len(df), size = observations)].copy()
    df_bpe["CAPACITE"] = 500
    ...
    df_bpe["TYPEQU"] = categories[random.randint(0, len(categories), size = len(df_bpe))]
